...
def compile_model(hook, model, learning_rate, decay):
...
## Train the model
def train_model(hook, model, model_dir, x_train, y_train, batch_size, epochs, learning_rate, decay):
    history = []
    
    # Compile the model
    optimizer, loss_fn, train_acc_metric, val_acc_metric = compile_model(hook, model, learning_rate, decay)
...
if __name__ == "__main__":
    ...
    train_model(hook, model, args.model_dir, x_train, y_train, args.batch_size, args.epochs, args.learning_rate, args.decay)
